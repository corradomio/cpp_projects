#ifndef BFLOAT16_H_INCLUDE_GUARD
#define BFLOAT16_H_INCLUDE_GUARD
...
// For a tagged version of the bfloat16 repository, having tag name
// "v" <major> "." <minor> "." <patch>, the following macro defines should
// match that tag:
#define BFLOAT16_MAJOR_VERSION 1
#define BFLOAT16_MINOR_VERSION 0
#define BFLOAT16_PATCH_VERSION 1
...
namespace numeric {
    ...
    private:
        ...
        static BFLOAT16_CONSTEXPR uint16_t convert_bits_of_normal_or_zero(
            const uint32_t bits) {
            return uint32_t{
    ...
    public:
        ...
        BFLOAT16_CONSTEXPR bfloat16_t(const uint16_t r, bool) : raw_bits_(r) {}
        ...
        // BFLOAT16_CONVERTING_CONSTRUCTORS. (The oneDNN library does allow
        // implicit conversion from float to bfloat_t.)
#ifndef BFLOAT16_CONVERTING_CONSTRUCTORS
        explicit
#endif
        ...
        // Note: This constructor is "explicit" by default, but can be adjusted
        // to allow implicit conversion to bfloat16_t by defining the macro
        // BFLOAT16_CONVERTING_CONSTRUCTORS.
        ...
        friend BFLOAT16_CONSTEXPR uint16_t get_raw_bits(const bfloat16_t&);
    };
    ...
    inline BFLOAT16_CONSTEXPR std::uint16_t get_raw_bits(const bfloat16_t& bf16)
    {
