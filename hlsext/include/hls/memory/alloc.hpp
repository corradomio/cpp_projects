...
namespace memory {
    ...
    class out_of_memory : public hls::lang::exception_t {
    public:
        out_of_memory() { }
    ...
    class memory_corrupted : public hls::lang::exception_t {
    public:
        memory_corrupted() { }
    ...
    class invalid_ptr : public hls::lang::exception_t {
    public:
        invalid_ptr() { }
    ...
    class already_free : public hls::lang::exception_t {
    public:
        already_free() { }
